...
use App\User;
use Modules\RoleManager\Entities\Role;
use Modules\RoleManager\Entities\Permission;
...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if ($this->command->confirm('Create Roles for user, default is admin and super admin and user? [y|N]', true)) {
            ...
            foreach($roles_array as $role) {
                ...
                if( $role->name == 'SuperAdmin' ) {
                    ...
                    $array = Permission::where('name', 'LIKE', 'add_%')->orWhere('name', 'LIKE', 'edit_%')->orWhere('name', 'LIKE', 'view_%')->get();
                    $role->syncPermissions($array);
                    $this->command->info('Admin granted add/edit/view the permissions');
                } else {
